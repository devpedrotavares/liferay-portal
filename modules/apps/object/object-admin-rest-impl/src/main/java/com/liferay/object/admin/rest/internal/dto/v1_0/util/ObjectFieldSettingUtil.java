...
public class ObjectFieldSettingUtil {
	...
	public static List<com.liferay.object.model.ObjectFieldSetting>
		...
		List<com.liferay.object.model.ObjectFieldSetting>
			serviceBuilderObjectFieldSettings = TransformUtil.transformToList(
		...
		List<String> serviceBuilderObjectFieldSettingNames = ListUtil.toList(
			serviceBuilderObjectFieldSettings,
			ObjectFieldSettingModel::getName);

		if (!FeatureFlagManagerUtil.isEnabled("LPS-163716") &&
			(serviceBuilderObjectFieldSettingNames.contains(
		...
		if (serviceBuilderObjectFieldSettingNames.contains(
				ObjectFieldSettingConstants.NAME_DEFAULT_VALUE) ||
			Validator.isNull(objectField.getDefaultValue())) {

			return serviceBuilderObjectFieldSettings;
		}

		serviceBuilderObjectFieldSettings.add(
