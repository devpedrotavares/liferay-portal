...
public interface ObjectEntryLocalService
	...
	public ObjectEntry addObjectEntry(
		...
		int status, Map<String, Serializable> values, ServiceContext serviceContext)
	...
	public ObjectEntry addOrUpdateObjectEntry(
		...
		long objectDefinitionId, int status, Map<String, Serializable> values,
	...
	public ObjectEntry updateObjectEntry(
		long userId, long objectEntryId, int status, Map<String, Serializable> values,
		ServiceContext serviceContext)
		throws PortalException;
