...
public class AttachmentObjectFieldBusinessType
	...
	public Map<Locale, Object> getLocalizedValues(
		...
		Map<Locale, Object> localizedValues = super.getLocalizedValues(
		...
		for (Map.Entry<Locale, Object> entry : localizedValues.entrySet()) {
			localizedValues.put(
				entry.getKey(), _extractFileEntryId(entry.getValue()));
		}
	...
	public Object getValue(
		...
		return _extractFileEntryId(super.getValue(objectField, userId, values));
	}
	...
	private Object _extractFileEntryId(Object value) throws PortalException {
