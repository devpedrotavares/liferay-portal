...
public class ObjectEntryLocalServiceImpl
	...
	public ObjectEntry addObjectEntry(
		...
		_validateStatus(objectDefinition, null, status);
	...
	public ObjectEntry updateObjectEntry(
		...
		_validateStatus(objectDefinition, objectEntry.getStatus(), status);
	...
	private void _validateStatus(
			ObjectDefinition objectDefinition, Integer previousStatus,
			Integer status)
		throws PortalException {
