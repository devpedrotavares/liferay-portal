...
public class ObjectDefinitionLocalServiceImpl
	...
	public ObjectDefinition addCustomObjectDefinition(
		...
		return _addObjectDefinition(
			null, userId, objectFolderId, null, null, creationPolicy,
			enableComments, enableLocalization, labelMap, true, name,
	...
	public ObjectDefinition addSystemObjectDefinition(
		...
		return _addObjectDefinition(
			...
			dbTableName, ObjectDefinitionConstants.CREATION_POLICY_DEFAULT,
	...
	public ObjectDefinition updateCustomObjectDefinition(
		...
		return _updateObjectDefinition(
			...
			null, creationPolicy, enableCategorization, enableComments,
	...
	private ObjectDefinition _addObjectDefinition(
			String externalReferenceCode, long userId, long objectFolderId,
			String className, String dbTableName, String creationPolicy,
			boolean enableComments, boolean enableLocalization,
			Map<Locale, String> labelMap, boolean modifiable, String name,
			String panelAppOrder, String panelCategoryKey,
			String pkObjectFieldDBColumnName, String pkObjectFieldName,
		...
		objectDefinition.setClassName(
			_getClassName(
				...
				system));
		objectDefinition.setCreationPolicy(creationPolicy);
	...
	private ObjectDefinition _updateObjectDefinition(
			...
			long descriptionObjectFieldId, long objectFolderId,
			long titleObjectFieldId, boolean accountEntryRestricted,
			boolean active, String dbTableName, String creationPolicy,
