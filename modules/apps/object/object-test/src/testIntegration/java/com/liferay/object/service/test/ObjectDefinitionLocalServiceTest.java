...
public class ObjectDefinitionLocalServiceTest {
	...
	public void testAddObjectDefinitionWithObjectDefinitionSettings()
		...
		_assertObjectDefinitionSetting(
			ObjectDefinitionSettingConstants.NAME_ACCEPT_ALL_GROUPS,
			StringPool.TRUE, objectDefinition.getObjectDefinitionSettings());
	...
	private void _assertObjectDefinitionSetting(
		...
		for (ObjectDefinitionSetting objectDefinitionSetting :
			...
			if (expectedName.equals(objectDefinitionSetting.getName())) {
				actualValue = objectDefinitionSetting.getValue();
