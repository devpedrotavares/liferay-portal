...
public class ObjectDefinitionLocalServiceTest {
	...
	public void testAddCustomObjectDefinition() throws Exception {
		...
		ObjectDefinition objectDefinition =
			_objectDefinitionLocalService.addCustomObjectDefinition(
				...
				ObjectDefinitionConstants.CREATION_POLICY_DEFAULT, false, false,
	...
	public void testUpdateCustomObjectDefinition() throws Exception {
		...
		objectDefinition =
			_objectDefinitionLocalService.updateCustomObjectDefinition(
				...
				ObjectDefinitionConstants.CREATION_POLICY_DEFAULT, true, false,
		...
		objectDefinition =
			_objectDefinitionLocalService.updateCustomObjectDefinition(
				...
				0, 0, 0, 0, false, objectDefinition.isActive(),
				ObjectDefinitionConstants.CREATION_POLICY_DEFAULT, true, false,
				false, false, LocalizedMapUtil.getLocalizedMap("Able"), "Able",
				null, null, false, LocalizedMapUtil.getLocalizedMap("Ables"),
				objectDefinition.getScope());
		...
		objectDefinition =
			_objectDefinitionLocalService.updateCustomObjectDefinition(
				null, objectDefinition.getObjectDefinitionId(), 0, 0, 0, 0,
				false, true, ObjectDefinitionConstants.CREATION_POLICY_DEFAULT,
	...
	public void testUpdateSystemObjectDefinition() throws Exception {
		...
		_assertFailure(
			...
			objectDefinitionId ->
				_objectDefinitionLocalService.updateCustomObjectDefinition(
					null, objectDefinitionId, 0, 0, 0, 0, false, true,
					ObjectDefinitionConstants.CREATION_POLICY_DEFAULT, false,
					true, false, false,
		...
		_assertFailure(
			...
			objectDefinitionId ->
				_objectDefinitionLocalService.updateCustomObjectDefinition(
					null, objectDefinitionId, 0, 0, 0, 0, false, false,
					ObjectDefinitionConstants.CREATION_POLICY_DEFAULT, false,
	...
	private ObjectDefinition _updateObjectDefinition(
		...
		return _objectDefinitionLocalService.updateCustomObjectDefinition(
			...
			ObjectDefinitionConstants.CREATION_POLICY_DEFAULT, false, false,
			false, enableObjectEntryHistory, labelMap, name, null, null, false,
