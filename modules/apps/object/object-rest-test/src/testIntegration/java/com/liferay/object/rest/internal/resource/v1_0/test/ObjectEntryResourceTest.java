	...
	public void testPutCustomObjectEntryWithLocalizedAttachmentObjectField()
		...
		jsonObject = HTTPTestUtil.invokeToJSONObject(
			JSONUtil.put(
				...
				JSONUtil.put(
					"en_US",
					JSONFactoryUtil.createJSONObject(testFileEntry.toString()))
			).toString(),
		...
		JSONObject localizedValuesJSONObject = jsonObject.getJSONObject(
			"localizedAttachment_i18n");

		_assertAttachmentJSONObject(
			dlFileEntry, Base64.encode(fileContent.getBytes()),
			localizedValuesJSONObject.getJSONObject("en_US"),
		...
		localizedValuesJSONObject = jsonObject.getJSONObject(
			"localizedAttachment_i18n");
		...
		fileEntryJSONObject = localizedValuesJSONObject.getJSONObject("pt_BR");
