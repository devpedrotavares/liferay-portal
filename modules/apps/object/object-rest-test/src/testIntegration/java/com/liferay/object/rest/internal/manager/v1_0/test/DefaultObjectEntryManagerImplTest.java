...
public class DefaultObjectEntryManagerImplTest {
	...
	public void testAddObjectEntry() throws Exception {
		...
		ObjectEntry dateTimeObjectEntry = _objectEntryManager.addObjectEntry(
			_dtoConverterContext, _objectDefinition2,
			new ObjectEntry() {
				{
		...
		Assert.assertEquals(
			...
			MapUtil.getString(
				dateTimeObjectEntry.getProperties(),
				"dateTimeObjectFieldName"));
		...
		ObjectEntry dateTimeUTCObjectEntry = _objectEntryManager.addObjectEntry(
		...
		Assert.assertEquals(
			...
			MapUtil.getString(
				dateTimeUTCObjectEntry.getProperties(),
				"dateTimeUTCObjectFieldName"));
	}
