...
public class ObjectEntriesTableFDSView extends BaseTableFDSView {
	...
	private void _addCustomObjectField(
		...
		if (Validator.isNull(objectField.getRelationshipType())) {
			_addFDSTableSchemaField(
				...
				label, false, objectField.getObjectFieldSettings(), objectField.isIndexed());
		}
			...
			if (titleObjectField == null) {
				_addFDSTableSchemaField(
					...
					objectField.getName(), label, false, objectField.getObjectFieldSettings(), false);
			}
			else {
				_addFDSTableSchemaField(
	...
	private void _addFDSTableSchemaField(
		...
		String label, boolean localizeLabel, List<ObjectFieldSetting> objectFieldSettings, boolean sortable) {
		...
		if (Objects.equals(
			...
			dateTimeFDSTableSchemaField.setFormat(
				JSONUtil.put(
					...
					"timeZone", ObjectFieldSettingUtil.getTimeZoneAsString(objectFieldSettings, user)
				).put(
					"year", "numeric"
				));
	...
	private void _addSystemObjectField(
		...
		if (Objects.equals(fieldName, "createDate")) {
			...
			_addFDSTableSchemaField(
				...
				_getLabel(fieldLabel, "external-reference-code"), true, null, true);
		}
